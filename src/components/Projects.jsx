...
const projects = [
  {
    ...
    description: 'A web-based laboratory booking system enabling faculty to create sessions and students to reserve slots in real-time. Features role-based access control and booking validation.',
  ...
  },
  {
    ...
    description: 'Analytics platform assessing faculty competencies and identifying skill gaps. Delivers interactive dashboards and data-driven training recommendations.',
    tech: ['React.js', 'Node.js', 'Express.js', 'MySQL', 'Tailwind CSS', 'Chart.js'],
  ...
  },
  {
    ...
    description: 'Digital platform streamlining internship assessments — allows mentors and faculty to evaluate student performance and generate detailed reports.',
...
const Projects = () => (
  <section id="projects" className="py-28 px-6 bg-[#111111]">
